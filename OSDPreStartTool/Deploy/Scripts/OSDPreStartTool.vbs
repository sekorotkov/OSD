...
Function DateTimeSync()
    ...
    For Each sPXETimeServer In cPXETimeServers
        ...
        End if
        ' Allow 0 
        ' Err.Number -2147024829 - 
        ' Err.Number -2147024891 - Access is denied
        ' Err.Number -2147024843 - The network path was not found. (Имя сервера не найдено)
...
' Warning message And DiskPart Clean if FS is Unknown (by DiskPart) on disk X
